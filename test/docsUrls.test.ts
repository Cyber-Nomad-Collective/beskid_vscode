...
describe("resolveDocumentationUrl", () => {
	test("passes through absolute http URLs", () => {
		expect(
			resolveDocumentationUrl("https://pckg.beskid-lang.org/docs/corelib@1.0.0"),
		).toBe("https://pckg.beskid-lang.org/docs/corelib@1.0.0");
	});
...
describe("buildPckgDocsUrl", () => {
	...
	test("omits fragment when symbol is absent", () => {
		expect(
			buildPckgDocsUrl("demo", "latest", undefined, {
				pckgBaseUrl: "https://pckg.beskid-lang.org",
			}),
		).toBe("https://pckg.beskid-lang.org/docs/demo@latest");
	});
});
...
describe("buildFallbackDocsUrl", () => {
	test("includes book search query when symbol provided", () => {
		expect(
			buildFallbackDocsUrl("Widget::value", {
				bookBaseUrl: "https://beskid-lang.org",
			}),
		).toBe("https://beskid-lang.org/book/?q=Widget%3A%3Avalue");
	});
});
