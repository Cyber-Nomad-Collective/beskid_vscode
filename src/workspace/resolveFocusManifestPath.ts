...
function isTreeItemTarget(input: unknown): input is { nodeType: string; projectUri?: string } {
...
export function resolveFocusManifestPath(input: FocusManifestInput): string | undefined {
