...
import type {
	BeskidDebugTreeProvider,
	DebugTreeItem,
} from "../debug/BeskidDebugTreeProvider.js";
...
function readDebugViewEnabled(): boolean {
	return (
		vscode.workspace
			...
			.get<boolean>("debug.enabled", false) ?? false
	);
}
...
export function registerViews(
	...
	return {
		projectsTreeView:
			views.beskidProjectsView as vscode.TreeView<ProjectsTreeItem>,
		debugTreeView,
		packagesTreeView:
			views.beskidPackagesView as vscode.TreeView<PackageTreeItem>,
	};
}
